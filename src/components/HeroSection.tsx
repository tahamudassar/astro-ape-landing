...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden cyber-grid">
      ...
      {/* Overlay gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-black via-purple-950/60 to-black" />
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="animate-fade-in-up">
          {/* Logo/Brand */}
          <div className="mb-8">
            <h1 className="text-6xl md:text-8xl font-black text-neon-purple neon-glow mb-4 animate-cyber-float glitch" data-text="ASTROAPE">
          ...
          <div className="mb-8 space-y-4">
            <h2 className="text-3xl md:text-5xl font-bold text-foreground">
              We craft <span className="text-neon-purple neon-glow">immersive</span>
            </h2>
            <h2 className="text-3xl md:text-5xl font-bold text-foreground">
              digital <span className="text-neon-purple-bright neon-glow">experiences</span>
            </h2>
          </div>
